...
public class Main {
    ...
    public static void writeObjectsToFile(Animal... animals) {
            for (Animal animal : animals) {
                String fileName = animal.getClass().getSimpleName().toLowerCase() + ".txt";
                try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(fileName))) {
                    oos.writeObject(animal);
                    System.out.println("Saved " + animal.getNameOfAnimal() + " to " + fileName);
                } catch (IOException e) {
                    System.out.println("Error saving " + animal.getNameOfAnimal() + ": " + e.getMessage());
                }
            }
        }
    ...
    public static void readObjectsFromFile() {
        try {
            ...
            Tiger tigerFromFile = (Tiger) tigerIn.readObject();
            Penguin penguinFromFile = (Penguin) penguinIn.readObject();
            Dolphin dolphinFromFile = (Dolphin) dolphinIn.readObject();
            ...
            // Display the state of animals
            System.out.println("The state of Tiger from file: ");
            System.out.println(tigerFromFile);
            System.out.println("The state of Penguin from file: ");
            System.out.println(penguinFromFile);
            System.out.println("The state of Dolphin from file: ");
            System.out.println(dolphinFromFile);
        } catch (IOException | ClassNotFoundException e) {
            System.out.println("Error reading animal data: " + e.getMessage());
        }
    }
}
